XHimera Core version 2.2.1 is now available from:

  <https://github.com/xhimera-project/xhimera/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/xhimera-project/xhimera/issues>

Compatibility
==============

XHimera Core is extensively tested on multiple operating systems using
...
XHimera Core should also work on most other Unix-like systems but is not
...
of Bitcoin that XHimera was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/xhimera-project-translations/).
