...
In order to support loading of multiple wallets in xhimera-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xhimera.cpp.
...
Changes to xhimera.cpp
----------------------
xhimera.cpp is the entry point into xhimera-qt, and as such, will require some minor modifications to provide hooks for
