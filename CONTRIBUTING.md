Contributing to XHimera Core
============================

The XHimera Core project operates an open contributor model where anyone is
...
The following applies to code changes to the XHimera Core project, and is not to be
confused with overall XHimera Network Protocol consensus changes.

Whether a pull request is merged into XHimera Core rests with the project merge
...
Patches that change XHimera consensus rules are considerably more involved than
...
Where a patch set proposes to change the XHimera consensus, it must have been
...
The project leader is the release manager for each XHimera Core release.
