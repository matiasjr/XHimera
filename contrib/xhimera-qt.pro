...
RESOURCES += src/qt/xhimera.qrc src/qt/xhimera_locale.qrc

TRANSLATIONS += src/qt/locale/xhimera_bg.ts \
                src/qt/locale/xhimera_de.ts \
                src/qt/locale/xhimera_en.ts \
                src/qt/locale/xhimera_es.ts \
                src/qt/locale/xhimera_fi.ts \
                src/qt/locale/xhimera_fr.ts \
                src/qt/locale/xhimera_it.ts \
                src/qt/locale/xhimera_ja.ts \
                src/qt/locale/xhimera_pl.ts \
                src/qt/locale/xhimera_pt.ts \
                src/qt/locale/xhimera_ru.ts \
                src/qt/locale/xhimera_sk.ts \
                src/qt/locale/xhimera_sv.ts \
                src/qt/locale/xhimera_vi.ts \
                src/qt/locale/xhimera_zh_CN.ts \
                src/qt/locale/xhimera_zh_TW.ts
