...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "XHimera server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XHimera features */
        {"xhimera", "masternode", &masternode, true, true, false},
        {"xhimera", "masternodelist", &masternodelist, true, true, false},
        {"xhimera", "mnbudget", &mnbudget, true, true, false},
        {"xhimera", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"xhimera", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xhimera", "mnsync", &mnsync, true, true, false},
        {"xhimera", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"xhimera", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xhimerad, or the -server option to xhimera-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> xhimera-cli " + methodname + " " + args + "\n";
}
