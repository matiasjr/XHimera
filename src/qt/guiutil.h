...
/** Utility functions used by the XHimera Qt UI.
 */
namespace GUIUtil
{
...
// Render XHimera addresses in monospace font
...
// Parse "xhimera:" URI into recipient object, return true on successful parsing
