                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("XHimera Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a XHimera address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and xhimera: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About XHimera Core"), this);
    aboutAction->setStatusTip(tr("Show information about XHimera Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for XHimera"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your XHimera addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified XHimera addresses"));
    ...
    openAction->setStatusTip(tr("Open a XHimera: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the XHimera Core help message to get a list with possible XHimera command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("XHimera Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XHimera network", "", count));
}
...
{
    QString strTitle = tr("XHimera Core"); // default title
