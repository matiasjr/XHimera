...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XHimera Core xhimera-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xhimera-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xhimera transaction") + "\n" +
                               "  xhimera-tx [options] -create [commands]   " + _("Create hex-encoded xhimera transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xhimera transaction
